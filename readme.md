...
- Lista de arquivos encontrados com:
  - Nome
  - Tamanho compactado
  - Tamanho real
  - Compressão
  - Indicação de arquivos possivelmente maliciosos

- Alertas de possíveis referências a executáveis caso os cabeçalhos estejam danificados.

---

## Segurança

- O script **não extrai nem executa** o conteúdo do ZIP.
- Pode ser executado em ambiente seguro sem risco de infecção.
